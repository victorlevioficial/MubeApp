...
All agents and skills must ALWAYS respond in Portuguese (pt-BR).  
Do not respond in any other language unless the user explicitly requests.

When user's prompt is NOT in Portuguese:
1. Internally translate for comprehension
2. Respond in Portuguese (pt-BR)
