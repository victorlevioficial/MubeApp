...
import '../features/feed/presentation/enhanced_feed_screen.dart';
...
import '../features/onboarding/presentation/enhanced_onboarding_type_screen.dart';
...
List<RouteBase> _buildRoutes(Ref ref) {
  return [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) => NoTransitionPage(
        key: state.pageKey,
        child: const EnhancedOnboardingTypeScreen(), // Using enhanced version
      ),
      routes: [
        GoRoute(
          path: 'form',
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              ...
              pageBuilder: (context, state) => NoTransitionPage(
                key: state.pageKey,
                child: const EnhancedFeedScreen(), // Using enhanced version
              ),
              routes: [
                GoRoute(
                  path: 'list',
