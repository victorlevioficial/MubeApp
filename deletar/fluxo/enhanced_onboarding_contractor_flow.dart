...
/// 2. Address
class EnhancedOnboardingContractorFlow extends ConsumerStatefulWidget {
  final AppUser user;

  const EnhancedOnboardingContractorFlow({super.key, required this.user});

  @override
  ConsumerState<EnhancedOnboardingContractorFlow> createState() =>
      _EnhancedOnboardingContractorFlowState();
}

class _EnhancedOnboardingContractorFlowState
    extends ConsumerState<EnhancedOnboardingContractorFlow> {
