...
class EnhancedOnboardingTypeScreen extends ConsumerStatefulWidget {
  const EnhancedOnboardingTypeScreen({super.key});

  @override
  ConsumerState<EnhancedOnboardingTypeScreen> createState() =>
      _EnhancedOnboardingTypeScreenState();
}

class _EnhancedOnboardingTypeScreenState
    extends ConsumerState<EnhancedOnboardingTypeScreen>
  ...
  void _submit(AppUser currentUser) {
    if (_selectedType != null) {
      ref.read(onboardingControllerProvider.notifier).selectProfileType(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: AppButton.primary(
                            ...
                            onPressed:
                                _selectedType != null ? () => _submit(user) : null,
                            isFullWidth: true,
                          ),
                        ),
