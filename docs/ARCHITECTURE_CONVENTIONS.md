# 🏗️ Convenções de Arquitetura - MubeApp

Este documento define as convenções e boas práticas para o desenvolvimento do MubeApp, baseado em lições aprendidas durante o projeto.
