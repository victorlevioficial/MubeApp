...
@JsonKey(name: 'tipo_perfil') AppUserType? get tipoPerfil;/// Account visibility status: 'ativo', 'rascunho', 'inativo', 'suspenso'.
/// Band creation flows must override this to 'rascunho' explicitly.
 ...
 String? get foto;/// Thumbnail-sized profile photo URL when available.
@JsonKey(name: 'foto_thumb') String? get fotoThumb;/// Short biography.
 String? get bio;/// Public profile handle used in shareable URLs like `mubeapp.com.br/@user`.
 String? get username;/// Location data: cidade, estado, lat, lng. (Legacy - kept for backward compatibility)
...
@JsonKey(name: 'contratante') Map<String, dynamic>? get dadosContratante;/// Number of times this user has been favorited (Received Favorites).
...
@JsonKey(name: 'privacy_settings') Map<String, dynamic> get privacySettings;/// Optional music streaming links shared across non-contractor profiles.
@JsonKey(name: 'music_links') Map<String, String> get musicLinks;/// MatchPoint configuration data.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppUser&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.email, email) || other.email == email)&&(identical(other.cadastroStatus, cadastroStatus) || other.cadastroStatus == cadastroStatus)&&(identical(other.tipoPerfil, tipoPerfil) || other.tipoPerfil == tipoPerfil)&&(identical(other.status, status) || other.status == status)&&(identical(other.nome, nome) || other.nome == nome)&&(identical(other.foto, foto) || other.foto == foto)&&(identical(other.fotoThumb, fotoThumb) || other.fotoThumb == fotoThumb)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.username, username) || other.username == username)&&const DeepCollectionEquality().equals(other.location, location)&&(identical(other.geohash, geohash) || other.geohash == geohash)&&const DeepCollectionEquality().equals(other.addresses, addresses)&&const DeepCollectionEquality().equals(other.dadosProfissional, dadosProfissional)&&const DeepCollectionEquality().equals(other.dadosBanda, dadosBanda)&&const DeepCollectionEquality().equals(other.dadosEstudio, dadosEstudio)&&const DeepCollectionEquality().equals(other.dadosContratante, dadosContratante)&&(identical(other.favoritesCount, favoritesCount) || other.favoritesCount == favoritesCount)&&const DeepCollectionEquality().equals(other.members, members)&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&const DeepCollectionEquality().equals(other.blockedUsers, blockedUsers)&&const DeepCollectionEquality().equals(other.privacySettings, privacySettings)&&const DeepCollectionEquality().equals(other.musicLinks, musicLinks)&&const DeepCollectionEquality().equals(other.matchpointProfile, matchpointProfile));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,email,cadastroStatus,tipoPerfil,status,nome,foto,fotoThumb,bio,username,const DeepCollectionEquality().hash(location),geohash,const DeepCollectionEquality().hash(addresses),const DeepCollectionEquality().hash(dadosProfissional),const DeepCollectionEquality().hash(dadosBanda),const DeepCollectionEquality().hash(dadosEstudio),const DeepCollectionEquality().hash(dadosContratante),favoritesCount,const DeepCollectionEquality().hash(members),const DeepCollectionEquality().hash(createdAt),const DeepCollectionEquality().hash(blockedUsers),const DeepCollectionEquality().hash(privacySettings),const DeepCollectionEquality().hash(musicLinks),const DeepCollectionEquality().hash(matchpointProfile)]);

@override
String toString() {
  return 'AppUser(uid: $uid, email: $email, cadastroStatus: $cadastroStatus, tipoPerfil: $tipoPerfil, status: $status, nome: $nome, foto: $foto, fotoThumb: $fotoThumb, bio: $bio, username: $username, location: $location, geohash: $geohash, addresses: $addresses, dadosProfissional: $dadosProfissional, dadosBanda: $dadosBanda, dadosEstudio: $dadosEstudio, dadosContratante: $dadosContratante, favoritesCount: $favoritesCount, members: $members, createdAt: $createdAt, blockedUsers: $blockedUsers, privacySettings: $privacySettings, musicLinks: $musicLinks, matchpointProfile: $matchpointProfile)';
}
...
@useResult
$Res call({
 String uid, String email,@JsonKey(name: 'cadastro_status') String cadastroStatus,@JsonKey(name: 'tipo_perfil') AppUserType? tipoPerfil, String status, String? nome, String? foto,@JsonKey(name: 'foto_thumb') String? fotoThumb, String? bio, String? username, Map<String, dynamic>? location, String? geohash, List<SavedAddress> addresses,@JsonKey(name: 'profissional') Map<String, dynamic>? dadosProfissional,@JsonKey(name: 'banda') Map<String, dynamic>? dadosBanda,@JsonKey(name: 'estudio') Map<String, dynamic>? dadosEstudio,@JsonKey(name: 'contratante') Map<String, dynamic>? dadosContratante,@JsonKey(name: 'favorites_count') int favoritesCount, List<String> members,@JsonKey(name: 'created_at') dynamic createdAt,@JsonKey(name: 'blocked_users') List<String> blockedUsers,@JsonKey(name: 'privacy_settings') Map<String, dynamic> privacySettings,@JsonKey(name: 'music_links') Map<String, String> musicLinks,@JsonKey(name: 'matchpoint_profile') Map<String, dynamic>? matchpointProfile
});
...
/// Create a copy of AppUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? email = null,Object? cadastroStatus = null,Object? tipoPerfil = freezed,Object? status = null,Object? nome = freezed,Object? foto = freezed,Object? fotoThumb = freezed,Object? bio = freezed,Object? username = freezed,Object? location = freezed,Object? geohash = freezed,Object? addresses = null,Object? dadosProfissional = freezed,Object? dadosBanda = freezed,Object? dadosEstudio = freezed,Object? dadosContratante = freezed,Object? favoritesCount = null,Object? members = null,Object? createdAt = freezed,Object? blockedUsers = null,Object? privacySettings = null,Object? musicLinks = null,Object? matchpointProfile = freezed,}) {
...
as String?,fotoThumb: freezed == fotoThumb ? _self.fotoThumb : fotoThumb // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>?,favoritesCount: null == favoritesCount ? _self.favoritesCount : favoritesCount // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>,musicLinks: null == musicLinks ? _self.musicLinks : musicLinks // ignore: cast_nullable_to_non_nullable
as Map<String, String>,matchpointProfile: freezed == matchpointProfile ? _self.matchpointProfile : matchpointProfile // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String email, @JsonKey(name: 'cadastro_status')  String cadastroStatus, @JsonKey(name: 'tipo_perfil')  AppUserType? tipoPerfil,  String status,  String? nome,  String? foto, @JsonKey(name: 'foto_thumb')  String? fotoThumb,  String? bio,  String? username,  Map<String, dynamic>? location,  String? geohash,  List<SavedAddress> addresses, @JsonKey(name: 'profissional')  Map<String, dynamic>? dadosProfissional, @JsonKey(name: 'banda')  Map<String, dynamic>? dadosBanda, @JsonKey(name: 'estudio')  Map<String, dynamic>? dadosEstudio, @JsonKey(name: 'contratante')  Map<String, dynamic>? dadosContratante, @JsonKey(name: 'favorites_count')  int favoritesCount,  List<String> members, @JsonKey(name: 'created_at')  dynamic createdAt, @JsonKey(name: 'blocked_users')  List<String> blockedUsers, @JsonKey(name: 'privacy_settings')  Map<String, dynamic> privacySettings, @JsonKey(name: 'music_links')  Map<String, String> musicLinks, @JsonKey(name: 'matchpoint_profile')  Map<String, dynamic>? matchpointProfile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppUser() when $default != null:
return $default(_that.uid,_that.email,_that.cadastroStatus,_that.tipoPerfil,_that.status,_that.nome,_that.foto,_that.fotoThumb,_that.bio,_that.username,_that.location,_that.geohash,_that.addresses,_that.dadosProfissional,_that.dadosBanda,_that.dadosEstudio,_that.dadosContratante,_that.favoritesCount,_that.members,_that.createdAt,_that.blockedUsers,_that.privacySettings,_that.musicLinks,_that.matchpointProfile);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String email, @JsonKey(name: 'cadastro_status')  String cadastroStatus, @JsonKey(name: 'tipo_perfil')  AppUserType? tipoPerfil,  String status,  String? nome,  String? foto, @JsonKey(name: 'foto_thumb')  String? fotoThumb,  String? bio,  String? username,  Map<String, dynamic>? location,  String? geohash,  List<SavedAddress> addresses, @JsonKey(name: 'profissional')  Map<String, dynamic>? dadosProfissional, @JsonKey(name: 'banda')  Map<String, dynamic>? dadosBanda, @JsonKey(name: 'estudio')  Map<String, dynamic>? dadosEstudio, @JsonKey(name: 'contratante')  Map<String, dynamic>? dadosContratante, @JsonKey(name: 'favorites_count')  int favoritesCount,  List<String> members, @JsonKey(name: 'created_at')  dynamic createdAt, @JsonKey(name: 'blocked_users')  List<String> blockedUsers, @JsonKey(name: 'privacy_settings')  Map<String, dynamic> privacySettings, @JsonKey(name: 'music_links')  Map<String, String> musicLinks, @JsonKey(name: 'matchpoint_profile')  Map<String, dynamic>? matchpointProfile)  $default,) {final _that = this;
switch (_that) {
case _AppUser():
return $default(_that.uid,_that.email,_that.cadastroStatus,_that.tipoPerfil,_that.status,_that.nome,_that.foto,_that.fotoThumb,_that.bio,_that.username,_that.location,_that.geohash,_that.addresses,_that.dadosProfissional,_that.dadosBanda,_that.dadosEstudio,_that.dadosContratante,_that.favoritesCount,_that.members,_that.createdAt,_that.blockedUsers,_that.privacySettings,_that.musicLinks,_that.matchpointProfile);case _:
  throw StateError('Unexpected subclass');
...
class _AppUser extends AppUser {
  const _AppUser({required this.uid, required this.email, @JsonKey(name: 'cadastro_status') this.cadastroStatus = 'tipo_pendente', @JsonKey(name: 'tipo_perfil') this.tipoPerfil, this.status = 'ativo', this.nome, this.foto, @JsonKey(name: 'foto_thumb') this.fotoThumb, this.bio, this.username, final  Map<String, dynamic>? location, this.geohash, final  List<SavedAddress> addresses = const [], @JsonKey(name: 'profissional') final  Map<String, dynamic>? dadosProfissional, @JsonKey(name: 'banda') final  Map<String, dynamic>? dadosBanda, @JsonKey(name: 'estudio') final  Map<String, dynamic>? dadosEstudio, @JsonKey(name: 'contratante') final  Map<String, dynamic>? dadosContratante, @JsonKey(name: 'favorites_count') this.favoritesCount = 0, final  List<String> members = const [], @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'blocked_users') final  List<String> blockedUsers = const [], @JsonKey(name: 'privacy_settings') final  Map<String, dynamic> privacySettings = const {}, @JsonKey(name: 'music_links') final  Map<String, String> musicLinks = const {}, @JsonKey(name: 'matchpoint_profile') final  Map<String, dynamic>? matchpointProfile}): _location = location,_addresses = addresses,_dadosProfissional = dadosProfissional,_dadosBanda = dadosBanda,_dadosEstudio = dadosEstudio,_dadosContratante = dadosContratante,_members = members,_blockedUsers = blockedUsers,_privacySettings = privacySettings,_musicLinks = musicLinks,_matchpointProfile = matchpointProfile,super._();
...
@override@JsonKey(name: 'foto_thumb') final  String? fotoThumb;
/// Short biography.
...
/// Optional music streaming links shared across non-contractor profiles.
 final  Map<String, String> _musicLinks;
/// Optional music streaming links shared across non-contractor profiles.
@override@JsonKey(name: 'music_links') Map<String, String> get musicLinks {
  if (_musicLinks is EqualUnmodifiableMapView) return _musicLinks;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_musicLinks);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppUser&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.email, email) || other.email == email)&&(identical(other.cadastroStatus, cadastroStatus) || other.cadastroStatus == cadastroStatus)&&(identical(other.tipoPerfil, tipoPerfil) || other.tipoPerfil == tipoPerfil)&&(identical(other.status, status) || other.status == status)&&(identical(other.nome, nome) || other.nome == nome)&&(identical(other.foto, foto) || other.foto == foto)&&(identical(other.fotoThumb, fotoThumb) || other.fotoThumb == fotoThumb)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.username, username) || other.username == username)&&const DeepCollectionEquality().equals(other._location, _location)&&(identical(other.geohash, geohash) || other.geohash == geohash)&&const DeepCollectionEquality().equals(other._addresses, _addresses)&&const DeepCollectionEquality().equals(other._dadosProfissional, _dadosProfissional)&&const DeepCollectionEquality().equals(other._dadosBanda, _dadosBanda)&&const DeepCollectionEquality().equals(other._dadosEstudio, _dadosEstudio)&&const DeepCollectionEquality().equals(other._dadosContratante, _dadosContratante)&&(identical(other.favoritesCount, favoritesCount) || other.favoritesCount == favoritesCount)&&const DeepCollectionEquality().equals(other._members, _members)&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&const DeepCollectionEquality().equals(other._blockedUsers, _blockedUsers)&&const DeepCollectionEquality().equals(other._privacySettings, _privacySettings)&&const DeepCollectionEquality().equals(other._musicLinks, _musicLinks)&&const DeepCollectionEquality().equals(other._matchpointProfile, _matchpointProfile));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,email,cadastroStatus,tipoPerfil,status,nome,foto,fotoThumb,bio,username,const DeepCollectionEquality().hash(_location),geohash,const DeepCollectionEquality().hash(_addresses),const DeepCollectionEquality().hash(_dadosProfissional),const DeepCollectionEquality().hash(_dadosBanda),const DeepCollectionEquality().hash(_dadosEstudio),const DeepCollectionEquality().hash(_dadosContratante),favoritesCount,const DeepCollectionEquality().hash(_members),const DeepCollectionEquality().hash(createdAt),const DeepCollectionEquality().hash(_blockedUsers),const DeepCollectionEquality().hash(_privacySettings),const DeepCollectionEquality().hash(_musicLinks),const DeepCollectionEquality().hash(_matchpointProfile)]);
...
/// Create a copy of AppUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? email = null,Object? cadastroStatus = null,Object? tipoPerfil = freezed,Object? status = null,Object? nome = freezed,Object? foto = freezed,Object? fotoThumb = freezed,Object? bio = freezed,Object? username = freezed,Object? location = freezed,Object? geohash = freezed,Object? addresses = null,Object? dadosProfissional = freezed,Object? dadosBanda = freezed,Object? dadosEstudio = freezed,Object? dadosContratante = freezed,Object? favoritesCount = null,Object? members = null,Object? createdAt = freezed,Object? blockedUsers = null,Object? privacySettings = null,Object? musicLinks = null,Object? matchpointProfile = freezed,}) {
...
as Map<String, dynamic>,musicLinks: null == musicLinks ? _self._musicLinks : musicLinks // ignore: cast_nullable_to_non_nullable
as Map<String, String>,matchpointProfile: freezed == matchpointProfile ? _self._matchpointProfile : matchpointProfile // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
