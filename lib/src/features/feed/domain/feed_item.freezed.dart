...
mixin _$FeedItem {
 ...
 String get uid; String get nome; String? get nomeArtistico; String? get foto; String? get categoria; List<String> get generosMusicais; String get tipoPerfil; Map<String, dynamic>? get location; int get favoriteCount; List<String> get skills; List<String> get subCategories; bool get isFavorited; double? get distanceKm;
...
@useResult
$Res call({
 String uid, String nome, String? nomeArtistico, String? foto, String? categoria, List<String> generosMusicais, String tipoPerfil, Map<String, dynamic>? location, int favoriteCount, List<String> skills, List<String> subCategories, bool isFavorited, double? distanceKm
});
...
as Map<String, dynamic>?,favoriteCount: null == favoriteCount ? _self.favoriteCount : favoriteCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String nome,  String? nomeArtistico,  String? foto,  String? categoria,  List<String> generosMusicais,  String tipoPerfil,  Map<String, dynamic>? location,  int favoriteCount,  List<String> skills,  List<String> subCategories,  bool isFavorited,  double? distanceKm)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedItem() when $default != null:
return $default(_that.uid,_that.nome,_that.nomeArtistico,_that.foto,_that.categoria,_that.generosMusicais,_that.tipoPerfil,_that.location,_that.favoriteCount,_that.skills,_that.subCategories,_that.isFavorited,_that.distanceKm);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String nome,  String? nomeArtistico,  String? foto,  String? categoria,  List<String> generosMusicais,  String tipoPerfil,  Map<String, dynamic>? location,  int favoriteCount,  List<String> skills,  List<String> subCategories,  bool isFavorited,  double? distanceKm)  $default,) {final _that = this;
switch (_that) {
case _FeedItem():
return $default(_that.uid,_that.nome,_that.nomeArtistico,_that.foto,_that.categoria,_that.generosMusicais,_that.tipoPerfil,_that.location,_that.favoriteCount,_that.skills,_that.subCategories,_that.isFavorited,_that.distanceKm);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String nome,  String? nomeArtistico,  String? foto,  String? categoria,  List<String> generosMusicais,  String tipoPerfil,  Map<String, dynamic>? location,  int favoriteCount,  List<String> skills,  List<String> subCategories,  bool isFavorited,  double? distanceKm)?  $default,) {final _that = this;
switch (_that) {
case _FeedItem() when $default != null:
return $default(_that.uid,_that.nome,_that.nomeArtistico,_that.foto,_that.categoria,_that.generosMusicais,_that.tipoPerfil,_that.location,_that.favoriteCount,_that.skills,_that.subCategories,_that.isFavorited,_that.distanceKm);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FeedItem&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.nome, nome) || other.nome == nome)&&(identical(other.nomeArtistico, nomeArtistico) || other.nomeArtistico == nomeArtistico)&&(identical(other.foto, foto) || other.foto == foto)&&(identical(other.categoria, categoria) || other.categoria == categoria)&&const DeepCollectionEquality().equals(other._generosMusicais, _generosMusicais)&&(identical(other.tipoPerfil, tipoPerfil) || other.tipoPerfil == tipoPerfil)&&const DeepCollectionEquality().equals(other._location, _location)&&(identical(other.favoriteCount, favoriteCount) || other.favoriteCount == favoriteCount)&&const DeepCollectionEquality().equals(other._skills, _skills)&&const DeepCollectionEquality().equals(other._subCategories, _subCategories)&&(identical(other.isFavorited, isFavorited) || other.isFavorited == isFavorited)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm));
}


@override
int get hashCode => Object.hash(runtimeType,uid,nome,nomeArtistico,foto,categoria,const DeepCollectionEquality().hash(_generosMusicais),tipoPerfil,const DeepCollectionEquality().hash(_location),favoriteCount,const DeepCollectionEquality().hash(_skills),const DeepCollectionEquality().hash(_subCategories),isFavorited,distanceKm);
